...
\begin{definition}{Continuità in $\mathbb{R}$}
	Sp.199 analisi 1 libro in prestito
\end{definition}
\begin{definition}{Continuità p.74}
	SSia
\end{definition}
\begin{definition}{Discontinuità in $\mathbb{R}$}
	Sp.202 analisi 1 libro in prestito
\end{definition}
\begin{definition}{Come dire se è una funzione continua o no?}
	Sp.204 -osservazione 1.1 analisi 1 libro in prestito
\end{definition}
...
\subsubsection{Funzioni Trigonometriche Classiche}
