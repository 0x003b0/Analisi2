...
\begin{theorem}{Disuguaglianza di Cauchy-Schwartz p.56}
	SSiano due vettori $\vec{x}, \vec{y} \in \mathbb{R}^n$
	\[
	|\langle \vec{x}, \vec{y} \rangle| \leq \|\vec{x}\| \cdot \|\vec{y}\| 
	\]
	Il valore assoluto del prodotto scalare è minore uguale $\leq$ al prodotto tra le norme dei due vettori.
	Spiega cos'è $\mathbb{R}^n$, spazio vettoriale o spazio euclideo a n-dimensioni?
\end{theorem}
